...
## ⚠️ Package Update Policy

### 🚫 Do Not Update These Packages

To maintain stability and compatibility within the project, **do not update the following package:**

| Package | Current Version | Reason                                                                                                                                                                                              |
| ------- | --------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `zod`   | `3.25.70`       | This version is fully compatible with our Express 5 validation middleware. Updating may break request validation or cause runtime errors (e.g., `Cannot set property query of #<IncomingMessage>`). |
